...
export const LiveClassroom = () => {
  ...
  // Fetch real lecturer programs from backend
  useEffect(() => {
  ...
  const fetchLecturerPrograms = async () => {
    try {
      console.log('=== FETCHING LECTURER PROGRAMS FOR LIVE CLASSROOM ===');
              ...
              <div key={classItem.id} className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">{classItem.students || 0} students</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Clock className="h-4 w-4 text-muted-foreground" />
                ...
                <div className="flex items-center gap-2">
                  {classItem.status === 'scheduled' && (
                    <Button 
                      size="sm" 
                      onClick={() => startLiveClass(classItem)}
