...
export default function VersionChecker() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-md">
      <div className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-lg shadow-2xl p-4 border border-primary">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-100 mb-3">
              A new version of BounceSteps is available. Please update to get the latest features and improvements.
            </p>
            <div className="flex gap-2">
              <button
                onClick={handleUpdate}
                className="px-4 py-2 bg-white text-primary rounded-md font-medium hover:bg-primary/5 transition-colors text-sm"
              >
                Update Now
              </button>
              <button
