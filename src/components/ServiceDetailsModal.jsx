              ...
              <div className="space-y-2">
                ...
                {service.contact_info.email?.enabled && service.contact_info.email?.address && (
                  <a
                    ...
                    className="flex items-center gap-3 p-3 bg-primary/5 dark:bg-primary/20 text-primary dark:text-primary/70 rounded-lg hover:bg-primary/10 dark:hover:bg-blue-900/30 transition-colors"
                  >
