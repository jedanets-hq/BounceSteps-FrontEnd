...
const ServiceCard = ({ 
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Unified Card - Image and details together */}
      ...
      {/* Details Section - Outside card on mobile, inside card on desktop */}
      <div className="md:bg-card md:border md:border-border md:rounded-lg md:overflow-hidden md:hover:shadow-lg md:transition-shadow md:mt-0 mt-2">
        <div className="md:p-3 md:p-5 flex flex-col flex-grow">
          ...
          {service.amenities && service.amenities.length > 0 && (
            <div className="max-md:hidden flex flex-wrap gap-1 md:gap-2 mb-2 md:mb-4">
          ...
          <div className="hidden md:flex flex-col gap-1.5 md:gap-2 mt-3 md:mt-4">
            {/* Desktop: All buttons */}
            ...
            <Button 
              size="sm"
              className="w-full bg-primary hover:bg-primary/90 text-sm py-3 h-auto leading-none"
