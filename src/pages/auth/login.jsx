...
const Login = () => {
  ...
  // Redirect if user is already logged in - go to home page
  useEffect(() => {
    if (!authLoading && user) {
          ...
          <div className="bg-background/90 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-border">
            ...
            <div className="mb-6">
              <Button
                ...
                disabled={isLoading}
                className="border-2 border-border hover:border-primary hover:bg-primary/5 transition-all duration-200 bg-white dark:bg-white"
              >
