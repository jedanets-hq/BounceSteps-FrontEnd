...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!acceptedTerms) {
      alert('Please accept the Privacy Policy, Terms & Conditions to continue.');
      return;
    }
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <Button variant="outline" onClick={handleGoogleRegister} className="w-full bg-white dark:bg-white">
