...
const EventAccess = () => {
  ...
  const fetchEventServices = async () => {
    try {
      ...
      if (data.success) {
        // For now, show all services or filter as needed
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse event services from verified providers
          </p>
        </div>
        ...
        {services.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">No Event Services Available</h3>
            <p className="text-muted-foreground mb-6">Check back later for new events</p>
              ...
              <div className="relative h-48 bg-gradient-to-br from-primary/10 to-primary/5">
                {service.images && service.images.length > 0 ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <Icon name="Calendar" size={48} className="text-primary/40" />
                  </div>
                )}
