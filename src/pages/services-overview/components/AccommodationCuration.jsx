...
const AccommodationCuration = () => {
  ...
  const fetchAccommodationServices = async () => {
    try {
      const response = await fetch(`${API_URL}/services?category=Accommodation`);
      ...
      <div className="bg-muted/30 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">Loading accommodation services...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse real accommodation services from verified providers
          </p>
        </div>
        ...
        {services.length === 0 ? (
          <div className="text-center py-12">
            <Icon name="Home" size={48} className="mx-auto mb-4 text-muted-foreground/50" />
            <h3 className="text-xl font-semibold text-foreground mb-2">No Accommodation Services Available</h3>
            <p className="text-muted-foreground mb-6">Check back later for new accommodations</p>
...
export default AccommodationCuration;
