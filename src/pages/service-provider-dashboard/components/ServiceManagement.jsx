...
const ServiceManagement = ({ editingServiceId: propEditingServiceId, onEditComplete }) => {
  ...
  const [serviceForm, setServiceForm] = useState({
    ...
    // Payment Methods
    paymentMethods: {
      bankAccount: { enabled: false, accountName: '', accountNumber: '', bankName: '', swiftCode: '' }
    },
    // Contact Information
    contactInfo: {
  ...
  const handleEditService = (service) => {
    ...
    setServiceForm({
      ...
      paymentMethods: {
        bankAccount: paymentMethods.bankAccount || { enabled: false, accountName: '', accountNumber: '', bankName: '', swiftCode: '' }
      },
      contactInfo: {
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <div className="mb-6 p-4 bg-muted/30 rounded-lg border border-border">
            <h4 className="font-medium text-foreground mb-4 flex items-center">
              ...
              Payment Methods
              <span className="ml-2 text-xs font-normal text-muted-foreground">(Bank Account Details)</span>
            </h4>
            <p className="text-xs text-muted-foreground mb-4">
              Provide your bank account details for receiving payments. This information will be used for payment processing.
            </p>
            
            <div className="space-y-4">
              {/* Bank Account */}
              <div className={`p-4 rounded-lg border transition-all ${serviceForm.paymentMethods.bankAccount.enabled ? 'border-primary bg-primary/5' : 'border-border'}`}>
                <div className="flex items-center justify-between mb-3">
                  <label className="flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={serviceForm.paymentMethods.bankAccount.enabled}
                      onChange={(e) => setServiceForm({
                        ...serviceForm,
                        paymentMethods: {
                          ...serviceForm.paymentMethods,
                          bankAccount: { ...serviceForm.paymentMethods.bankAccount, enabled: e.target.checked }
                        }
                      })}
                ...
                {serviceForm.paymentMethods.bankAccount.enabled && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                    <input
                      type="text"
                      placeholder="Account Holder Name"
                      value={serviceForm.paymentMethods.bankAccount.accountName}
                      onChange={(e) => setServiceForm({
                        ...serviceForm,
                        paymentMethods: {
                          ...serviceForm.paymentMethods,
                          bankAccount: { ...serviceForm.paymentMethods.bankAccount, accountName: e.target.value }
                        }
                      })}
                    ...
                    <input
                      ...
                      value={serviceForm.paymentMethods.bankAccount.accountNumber}
                      onChange={(e) => setServiceForm({
                        ...serviceForm,
                        paymentMethods: {
                          ...serviceForm.paymentMethods,
                          bankAccount: { ...serviceForm.paymentMethods.bankAccount, accountNumber: e.target.value }
                        }
                      })}
                      className="px-3 py-2 border border-border rounded-lg bg-background text-foreground text-sm"
                    />
                    <input
                      ...
                      value={serviceForm.paymentMethods.bankAccount.bankName}
                      onChange={(e) => setServiceForm({
                        ...serviceForm,
                        paymentMethods: {
                          ...serviceForm.paymentMethods,
                          bankAccount: { ...serviceForm.paymentMethods.bankAccount, bankName: e.target.value }
                        }
                      })}
                      className="px-3 py-2 border border-border rounded-lg bg-background text-foreground text-sm"
                    />
                    <input
                      ...
                      value={serviceForm.paymentMethods.bankAccount.swiftCode}
                      onChange={(e) => setServiceForm({
                        ...serviceForm,
                        paymentMethods: {
                          ...serviceForm.paymentMethods,
                          bankAccount: { ...serviceForm.paymentMethods.bankAccount, swiftCode: e.target.value }
                        }
                      })}
                      className="px-3 py-2 border border-border rounded-lg bg-background text-foreground text-sm"
                    />
