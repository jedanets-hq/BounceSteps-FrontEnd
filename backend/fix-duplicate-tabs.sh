...
# ============================================
# ISAFARI - FIX DUPLICATE TABS SCRIPT
# ============================================
...
echo -e "${BLUE}"
echo "============================================"
echo "  iSafari - Fix Dashboard Tabs"
echo "============================================"
echo -e "${NC}"
...
BACKUP_DIR="backups/tabs-fix-$(date +%Y%m%d-%H%M%S)"
mkdir -p "$BACKUP_DIR"

if [ -f "src/pages/service-provider-dashboard/index.jsx" ]; then
    cp src/pages/service-provider-dashboard/index.jsx "$BACKUP_DIR/index.jsx.backup"
    echo -e "${GREEN}✓${NC} Backed up: index.jsx"
fi

if [ -f "src/pages/service-provider-dashboard/components/BookingManagement.jsx" ]; then
    cp src/pages/service-provider-dashboard/components/BookingManagement.jsx "$BACKUP_DIR/BookingManagement.jsx.backup"
    echo -e "${GREEN}✓${NC} Backed up: BookingManagement.jsx"
fi
...
# ============================================
# STEP 2: Update BookingManagement - Remove Sub-Tabs
# ============================================
echo -e "${BLUE}🔄 Step 2: Simplifying BookingManagement...${NC}"

cat > src/pages/service-provider-dashboard/components/BookingManagement.jsx << 'EOF'
...
echo -e "${GREEN}✓ BookingManagement simplified${NC}"
echo ""

# ============================================
# STEP 3: Rebuild
# ============================================
echo -e "${BLUE}🔄 Step 3: Rebuilding...${NC}"

npm run build

echo ""
echo -e "${GREEN}✓ ALL DONE! Dashboard tabs simplified!${NC}"
echo ""
